...
def test_clicking_on_anchor_scrolls_page(driver: WebDriver, pages: Pages) -> None:
...
def test_should_scroll_to_click_on_an_element_hidden_by_overflow(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_click_on_an_element_hidden_by_overflow(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_click_on_an_element_hidden_by_double_overflow(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_click_on_an_element_hidden_by_yoverflow(driver: WebDriver, pages: Pages) -> None:
...
def test_should_not_scroll_overflow_elements_which_are_visible(driver: WebDriver, pages: Pages) -> None:
...
@pytest.mark.xfail_firefox
@pytest.mark.xfail_remote
def test_should_not_scroll_if_already_scrolled_and_element_is_in_view(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_click_radio_button_scrolled_into_view(driver: WebDriver, pages: Pages) -> None:
...
def test_should_scroll_overflow_elements_if_click_point_is_out_of_view_but_element_is_in_view(driver: WebDriver, pages: Pages) -> None:
...
@pytest.mark.xfail_remote(
    reason='https://github.com/w3c/webdriver/issues/408')
@pytest.mark.xfail_safari
def test_should_be_able_to_click_element_in_aframe_that_is_out_of_view(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_click_element_that_is_out_of_view_in_aframe(driver: WebDriver, pages: Pages) -> None:
...
def test_should_not_be_able_to_click_element_that_is_out_of_view_in_anon_scrollable_frame(driver: WebDriver, pages: Pages) -> None:
...
@pytest.mark.xfail_safari
def test_should_be_able_to_click_element_that_is_out_of_view_in_aframe_that_is_out_of_view(driver: WebDriver, pages: Pages) -> None:
...
@pytest.mark.xfail_remote
def test_should_be_able_to_click_element_that_is_out_of_view_in_anested_frame(driver: WebDriver, pages: Pages) -> None:
...
@pytest.mark.xfail_chrome
@pytest.mark.xfail_remote
def test_should_be_able_to_click_element_that_is_out_of_view_in_anested_frame_that_is_out_of_view(driver: WebDriver, pages: Pages) -> None:
...
def test_should_not_scroll_when_getting_element_size(driver: WebDriver, pages: Pages) -> None:
    pages.load("scroll3.html")
    scrollTop = get_scroll_top(driver)
