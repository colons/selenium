...
def test_should_return_null_when_getting_the_value_of_an_attribute_that_is_not_listed(driver: WebDriver, pages: Pages) -> None:
...
def test_should_return_null_when_getting_src_attribute_of_invalid_img_tag(driver: WebDriver, pages: Pages) -> None:
    pages.load("simpleTest.html")
...
def test_should_return_an_absolute_url_when_getting_src_attribute_of_avalid_img_tag(driver: WebDriver, pages: Pages) -> None:
    pages.load("simpleTest.html")
...
def test_should_return_an_absolute_url_when_getting_href_attribute_of_avalid_anchor_tag(driver: WebDriver, pages: Pages) -> None:
    pages.load("simpleTest.html")
...
def test_should_return_empty_attribute_values_when_present_and_the_value_is_actually_empty(driver: WebDriver, pages: Pages) -> None:
    pages.load("simpleTest.html")
    body = driver.find_element(By.XPATH, "//body")
    assert "" == body.get_attribute("style")


def test_should_return_the_value_of_the_disabled_attribute_as_false_if_not_set(driver: WebDriver, pages: Pages) -> None:
...
def test_should_return_the_value_of_the_index_attribute_even_if_it_is_missing(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_indicate_the_elements_that_are_disabled_are_not_is_enabled(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_elements_should_be_disabled_if_they_are_disabled_using_random_disabled_strings(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_indicate_when_atext_area_is_disabled(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_throw_exception_if_sending_keys_to_element_disabled_using_random_disabled_strings(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
    disabledTextElement1 = driver.find_element(By.ID, "disabledTextElement1")
...
def test_should_indicate_when_aselect_is_disabled(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_return_the_value_of_checked_for_acheckbox_even_if_it_lacks_that_attribute(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_return_the_value_of_selected_for_radio_buttons_even_if_they_lack_that_attribute(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_return_the_value_of_selected_for_options_in_selects_even_if_they_lack_that_attribute(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_return_value_of_class_attribute_of_an_element(driver: WebDriver, pages: Pages) -> None:
...
# def test_should_return_value_of_class_attribute_of_an_element_after_switching_iframe(driver: WebDriver, pages: Pages) -> None:
...
def test_should_return_the_contents_of_atext_area_as_its_value(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
    value = driver.find_element(By.ID, "withText").get_attribute("value")
    assert "Example text" == value


def test_should_return_the_contents_of_atext_area_as_its_value_when_set_to_non_norminal_true(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_treat_readonly_as_avalue(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_get_numeric_attribute(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
    element = driver.find_element(By.ID, "withText")
    assert "5" == element.get_attribute("rows")


def test_can_return_atext_approximation_of_the_style_attribute(driver: WebDriver, pages: Pages) -> None:
    pages.load("javascriptPage.html")
    style = driver.find_element(By.ID, "red-item").get_attribute("style")
    assert "background-color" in style.lower()


def test_should_correctly_report_value_of_colspan(driver: WebDriver, pages: Pages) -> None:
...
def test_can_retrieve_the_current_value_of_atext_form_field_text_input(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_can_retrieve_the_current_value_of_atext_form_field_email_input(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_can_retrieve_the_current_value_of_atext_form_field_text_area(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
def test_should_return_null_for_non_present_boolean_attributes(driver: WebDriver, pages: Pages) -> None:
...
def test_should_return_true_for_present_boolean_attributes(driver: WebDriver, pages: Pages) -> None:
    pages.load("booleanAttributes.html")
...
def test_should_get_unicode_chars_from_attribute(driver: WebDriver, pages: Pages) -> None:
    pages.load("formPage.html")
...
@pytest.mark.xfail_safari
@pytest.mark.xfail_remote
def test_should_get_values_and_not_miss_items(driver: WebDriver, pages: Pages) -> None:
