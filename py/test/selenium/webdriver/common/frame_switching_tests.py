...
def test_should_always_focus_on_the_top_most_frame_after_anavigation_event(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.find_element(By.TAG_NAME, "frameset")  # Test passes if this does not throw.


def test_should_not_automatically_switch_focus_to_an_iframe_when_apage_containing_them_is_loaded(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
    driver.find_element(By.ID, "iframe_page_heading")


def test_should_open_page_with_broken_frameset(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_switch_to_aframe_by_its_index(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.switch_to.frame(1)
    assert driver.find_element(By.ID, "pageNumber").text == "2"


def test_should_be_able_to_switch_to_an_iframe_by_its_index(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
    driver.switch_to.frame(0)
    assert driver.find_element(By.NAME, "id-name1").get_attribute("value") == "name"


def test_should_be_able_to_switch_to_aframe_by_its_name(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.switch_to.frame("fourth")
    assert driver.find_element(By.TAG_NAME, "frame").get_attribute("name") == "child1"


def test_should_be_able_to_switch_to_an_iframe_by_its_name(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
    driver.switch_to.frame("iframe1-name")
    assert driver.find_element(By.NAME, "id-name1").get_attribute("value") == "name"


def test_should_be_able_to_switch_to_aframe_by_its_id(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.switch_to.frame("fifth")
    assert driver.find_element(By.NAME, "windowOne").text == "Open new window"


def test_should_be_able_to_switch_to_an_iframe_by_its_id(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
    driver.switch_to.frame("iframe1")
    assert driver.find_element(By.NAME, "id-name1").get_attribute("value") == "name"


def test_should_be_able_to_switch_to_frame_with_name_containing_dot(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.switch_to.frame("sixth.iframe1")
    assert "Page number 3" in driver.find_element(By.TAG_NAME, "body").text


def test_should_be_able_to_switch_to_aframe_using_apreviously_located_web_element(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
...
def test_should_be_able_to_switch_to_an_iframe_using_apreviously_located_web_element(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
...
def test_should_ensure_element_is_aframe_before_switching(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
...
def test_frame_searches_should_be_relative_to_the_currently_selected_frame(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
...
def test_should_select_child_frames_by_chained_calls(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
...
def test_should_throw_frame_not_found_exception_looking_up_sub_frames_with_super_frame_names(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.switch_to.frame(driver.find_element(By.NAME, "fourth"))
    with pytest.raises(NoSuchElementException):
        driver.switch_to.frame(driver.find_element(By.NAME, "second"))
...
def test_should_throw_an_exception_when_aframe_cannot_be_found(driver: WebDriver, pages: Pages) -> None:
    pages.load("xhtmlTest.html")
    with pytest.raises(NoSuchElementException):
        driver.switch_to.frame(driver.find_element(By.NAME, "Nothing here"))


def test_should_throw_an_exception_when_aframe_cannot_be_found_by_index(driver: WebDriver, pages: Pages) -> None:
    pages.load("xhtmlTest.html")
    with pytest.raises(NoSuchFrameException):
        driver.switch_to.frame(27)


def test_should_be_able_to_switch_to_parent_frame(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.switch_to.frame(driver.find_element(By.NAME, "fourth"))
...
def test_should_be_able_to_switch_to_parent_frame_from_asecond_level_frame(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.switch_to.frame(driver.find_element(By.NAME, "fourth"))
...
def test_switching_to_parent_frame_from_default_context_is_no_op(driver: WebDriver, pages: Pages) -> None:
    pages.load("xhtmlTest.html")
    driver.switch_to.parent_frame()
    assert driver.title == "XHTML Test Page"


def test_should_be_able_to_switch_to_parent_from_an_iframe(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
    driver.switch_to.frame(0)
    driver.switch_to.parent_frame()
    driver.find_element(By.ID, "iframe_page_heading")
...
def test_should_continue_to_refer_to_the_same_frame_once_it_has_been_selected(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
...
@pytest.mark.xfail_remote(raises=WebDriverException,
                          reason='https://github.com/mozilla/geckodriver/issues/610')
@pytest.mark.xfail_safari
def test_should_focus_on_the_replacement_when_aframe_follows_alink_to_a_top_targeted_page(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.switch_to.frame(0)
...
def test_should_allow_auser_to_switch_from_an_iframe_back_to_the_main_content_of_the_page(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
    driver.switch_to.frame(0)
    driver.switch_to.default_content()
    driver.find_element(By.ID, "iframe_page_heading")
...
def test_should_allow_the_user_to_switch_to_an_iframe_and_remain_focused_on_it(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
    driver.switch_to.frame(0)
...
def test_should_be_able_to_click_in_aframe(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
...
def test_should_be_able_to_click_in_aframe_that_rewrites_top_window_location(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_click_in_asub_frame(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
...
def test_should_be_able_to_find_elements_in_iframes_by_xpath(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
    driver.switch_to.frame(driver.find_element(By.ID, "iframe1"))
...
def test_get_current_url_returns_top_level_browsing_context_url(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
...
def test_get_current_url_returns_top_level_browsing_context_url_for_iframes(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
...
def test_should_be_able_to_switch_to_the_top_if_the_frame_is_deleted_from_under_us(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_switch_to_the_top_if_the_frame_is_deleted_from_under_us_with_frame_index(driver: WebDriver, pages: Pages) -> None:
    pages.load("frame_switching_tests/deletingFrame.html")
    iframe = 0
...
def test_frame_to_be_available_and_switch_to_it_using_string_inputs(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_switch_to_the_top_if_the_frame_is_deleted_from_under_us_with_webelement(driver: WebDriver, pages: Pages) -> None:
    pages.load("frame_switching_tests/deletingFrame.html")
...
# @pytest.mark.xfail_safari
# def test_should_not_be_able_to_do_anything_the_frame_is_deleted_from_under_us(driver: WebDriver, pages: Pages) -> None:
#     pages.load("frame_switching_tests/deletingFrame.html")
#     driver.switch_to.frame(driver.find_element(By.ID, "iframe1"))
...
def test_should_return_window_title_in_aframeset(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
    driver.switch_to.frame(driver.find_element(By.NAME, "third"))
    assert "Unique title" == driver.title


def test_java_script_should_execute_in_the_context_of_the_current_frame(driver: WebDriver, pages: Pages) -> None:
    pages.load("frameset.html")
...
@pytest.mark.xfail_safari
def test_should_not_switch_magically_to_the_top_window(driver: WebDriver, pages: Pages) -> None:
...
def test_get_should_switch_to_default_context(driver: WebDriver, pages: Pages) -> None:
    pages.load("iframes.html")
