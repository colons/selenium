...
def test_get_screenshot_as_base64(driver: WebDriver, pages: Pages) -> None:
    pages.load("simpleTest.html")
    result = base64.b64decode(driver.get_screenshot_as_base64())
    assert imghdr.what('', result) == 'png'


def test_get_screenshot_as_png(driver: WebDriver, pages: Pages) -> None:
    pages.load("simpleTest.html")
...
def test_get_element_screenshot(driver: WebDriver, pages: Pages) -> None:
    pages.load("simpleTest.html")
