...
def reset_timeouts(driver: WebDriver) -> Iterable[None]:
    driver.set_script_timeout(5)
    yield
    driver.set_script_timeout(30)


def test_should_not_timeout_if_callback_invoked_immediately(driver: WebDriver, pages: Pages) -> None:
...
def test_should_be_able_to_return_javascript_primitives_from_async_scripts_neither_none_nor_undefined(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_be_able_to_return_javascript_primitives_from_async_scripts_null_and_undefined(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_be_able_to_return_an_array_literal_from_an_async_script(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_be_able_to_return_an_array_object_from_an_async_script(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_be_able_to_return_arrays_of_primitives_from_async_scripts(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_be_able_to_return_web_elements_from_async_scripts(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_be_able_to_return_arrays_of_web_elements_from_async_scripts(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_timeout_if_script_does_not_invoke_callback(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_timeout_if_script_does_not_invoke_callback_with_azero_timeout(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
    with pytest.raises(TimeoutException):
        driver.execute_async_script("window.setTimeout(function() {}, 0);")


def test_should_not_timeout_if_script_callsback_inside_azero_timeout(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_timeout_if_script_does_not_invoke_callback_with_long_timeout(driver: WebDriver, pages: Pages) -> None:
...
def test_should_detect_page_loads_while_waiting_on_an_async_script_and_return_an_error(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_catch_errors_when_executing_initial_script(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
    with pytest.raises(WebDriverException):
        driver.execute_async_script("throw Error('you should catch this!');")


def test_should_be_able_to_execute_asynchronous_scripts(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
...
def test_should_be_able_to_pass_multiple_arguments_to_async_scripts(driver: WebDriver, pages: Pages) -> None:
    pages.load("ajaxy_page.html")
    result = driver.execute_async_script("""
...
# def test_should_be_able_to_make_xmlhttp_requests_and_wait_for_the_response(driver: WebDriver, pages: Pages) -> None:
#    script = """
#        var url = arguments[0];
#        var callback = arguments[arguments.length - 1];
